...
<c:if test="${not empty message}">
            ...
            <form action="manage-customer" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <label for="username" class="col-md-2 col-form-label">Tên đăng nhập</label>
                    <div class="col-md-10">
                ...
                <div class="row mb-3">
                    <label for="sex" class="col-md-2 col-form-label">Giới tính</label>
                    <div class="col-md-10">
                ...
                <div class="row mb-3">
                    <label for="socialSecurityNumber" class="col-md-2 col-form-label">Số chứng minh thư</label>
                    <div class="col-md-10">
                        <input type="number" name="socialSecurityNumber" class="form-control" id="socialSecurityNumber" required />
                    </div>
                </div>

                <div class="row mb-3">
                    <label for="birthday" class="col-md-2 col-form-label">Ngày sinh</label>
                    <div class="col-md-10">
