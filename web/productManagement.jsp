...
<body>
    <div class="container">
        ...
        <div class="mb-3 text-end">
            <a href="addOrEditProduct.jsp" class="btn btn-primary">Thêm mới Sản phẩm</a>
        </div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="addOrEditProduct.jsp?id=1" class="btn btn-warning btn-sm">Chỉnh sửa</a>
                ...
                <tr>
                    ...
                    <td>
                        <a href="addOrEditProduct.jsp?id=2" class="btn btn-warning btn-sm">Chỉnh sửa</a>
                        <button class="btn btn-danger btn-sm">Xóa</button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a href="addOrEditProduct.jsp?id=3" class="btn btn-warning btn-sm">Chỉnh sửa</a>
                        <button class="btn btn-danger btn-sm">Xóa</button>
                    </td>
                </tr>
            </tbody>
